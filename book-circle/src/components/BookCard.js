			...
			<Modal show={modal} onHide={toggle}>
				...
				<div className="modal-footer">
					<div className="left-silde">
						<a href={previewLink} className="btn theme-btn book-card" color="default" type="button" target="_blank" rel="noopener noreferrer">
							Preview Link
						</a>
					</div>
					<div className="divider"></div>
					<div className="right-silde">
						<a href={infoLink} className="btn theme-btn book-card" color="default" type="button" target="_blank" rel="noopener noreferrer">
							Info Link
						</a>
					</div>
				</div>
